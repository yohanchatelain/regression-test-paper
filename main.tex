...
\begin{figure}
    ...
    \caption{Leave-one-out evaluation for non-regression tests.
        ...
        (RR) $\alpha^\star=0.005$, $\fwhm^\star=16$mm,
        (RS) $\alpha^\star=0.005$, $\fwhm^\star=16$mm,
        (RR+RS) $\alpha^\star=0.005$, $\fwhm^\star=19$mm}
    \label{fig:mct}
\end{figure}
...
\begin{figure}
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \caption{\centering Random Rounding (RR) $\alpha^\star=0.15$, $\fwhm^\star=15$mm}
        \label{fig:rr}
    \end{subfigure}
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rs.png}
        \caption{\centering Random Seed (RS) $\alpha^\star=0.25$, $\fwhm^\star=19$mm}
        \label{fig:rs}
    \end{subfigure}
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rr-rs.png}
        \caption{\centering Random Rounding + Random Seed (RR+RS). $\alpha^\star=0.2$, $\fwhm^\star=20$mm}
        \label{fig:rr-rs}
    \end{subfigure}
